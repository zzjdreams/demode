...
% Last Modified by GUIDE v2.5 19-Nov-2019 21:25:26
...
%给下拉框提供00000~111111内容
strc={};str=zeros(1,63);
for n=1:63
   str(n)=n; 
   
   strc=[strc,EJZ(dec2bin(str(n)))];
%    strc(n)=dec2bin(str(n))
%    strc(n)=num2cell(str(n));
   
end
% str={'000000','000001','000010'};
set(handles.popupmenu1,'string',strc);
...
handles.f=f;
global Psnr;
Psnr=str2double(get(handles.edit3,'String'));
handles.Psnr=Psnr;
uiwait(handles.figure1);
shuzi;
delete(hObject);
